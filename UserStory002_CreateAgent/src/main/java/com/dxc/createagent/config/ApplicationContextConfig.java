...
import com.dxc.createagent.dao.implement.AccountDAOImpl;
import com.dxc.createagent.dao.implement.AgentDAOImpl;

@Configuration
@ComponentScan("com.dxc.createagent")
...
public class ApplicationContextConfig {
	...
	public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
		...
		factoryBean.setPackagesToScan("com.dxc.createagent.entity");
